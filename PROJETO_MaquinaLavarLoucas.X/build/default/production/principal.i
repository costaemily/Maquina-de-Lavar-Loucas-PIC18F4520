...
int liquidoSecante, escoamentoDoLiquidoSecante;
char estadoMes[15];
...
int timer(int min) {
    ...
    unsigned char segU, segD, minU, minD;
    ...
    for (unsigned char k = min; k > 0; k--) {
        ...
        for (unsigned char i = 60; i > 0; i--) {
            ...
            for (unsigned char j = 0; j < 30; j++) {
                PORTA = 0x20;
                PORTD = display7s(segU);
                _delay((unsigned long)((1)*(8000000/4000.0)));
                PORTA = 0x10;
                PORTD = display7s(segD);
                _delay((unsigned long)((1)*(8000000/4000.0)));
                PORTA = 0x08;
                PORTD = display7s(minU);
                _delay((unsigned long)((1)*(8000000/4000.0)));
                PORTA = 0x04;
                PORTD = display7s(minD);
                _delay((unsigned long)((1)*(8000000/4000.0)));
            }
        }
    }
...
void estadosMaquina(void) {
    ...
    if ((desligado == 1) && (PORTBbits.RB0 == 0)) {
        desligado = 0;
        PORTBbits.RB7 = 1;
        sprintf(estadoMes, "LIGADA");
        escreve();
        _delay((unsigned long)((20)*(8000000/4000.0)));
    } else if ((desligado == 0) && (PORTBbits.RB1 == 0)) {
        enchendoDeAguaESabao = 1;
        PORTBbits.RB6 = 1;
        PORTBbits.RB5 = 1;
        ...
        escreve();
        _delay((unsigned long)((20)*(8000000/4000.0)));
    } else if (enchendoDeAguaESabao == 1) {
        if ((PORTBbits.RB0 == 0) || (PORTBbits.RB1 == 0)) {
            PORTCbits.RC5 = 0;
            enchendoDeAguaESabao = 0;
            escoamentoDoLiquidoSecante = 1;
            PORTBbits.RB6 = 0;
            PORTBbits.RB5 = 1;
            ...
            statusTimer = timer(20);
            PORTCbits.RC2 = 0;
        }
    } else if (cicloDeLavagem == 1) {
        if ((PORTBbits.RB0 == 0) || (PORTBbits.RB1 == 0)) {
            cicloDeLavagem = 0;
            escoamentoDoLiquidoSecante = 1;
            PORTBbits.RB5 = 1;
    ...
    } else if ((liquidoSecante == 1) &&
       (PORTBbits.RB1 == 0 || PORTBbits.RB0 == 0 || statusTimer == 1)) {
        statusTimer = 0;
        liquidoSecante = 0;
        escoamentoDoLiquidoSecante = 1;
        PORTBbits.RB6 = 0;
        ...
        sprintf(estadoMes, "ESCOANDO");
        escreve();
    } else if (escoamentoDoLiquidoSecante == 1) {
        if ((PORTBbits.RB3 == 0)) {
            escoamentoDoLiquidoSecante = 0;
            desligado = 1;
            PORTBbits.RB7 = 0;
            PORTBbits.RB5 = 0;
            tocaBuzzer();
